...
//        if name == ""{
//            throw NameError.CannotHaveNoName
//        }else if name.count > 35{
//            throw NameError.NameTooLong
//        }
//
//        if age < 0{
...
//
//do{
//    let human = try Human(name: "tony", age: 35)
//    print("My human: \(human.name) and \(human.age)")
//   }
//catch let error {
//
//    // Once 'caught', we can print out the error for more information and prevents our app from crashing
...
// */
////var human: Human = Human(name: "", age: 3)
//
///*:
// - Experiment:
...
////
//
//func validateUserPassEmail(username : String?, password : String?, email : String?) throws -> Bool{
...
//                throw EmailError.BadEmailAddress
//            }
//        } else {
//            print("bad password \(password)")
//            throw EmailError.BadPassword
//        }
//    }else{
//        print("bad username \(username)")
//        throw EmailError.BadUsername
//    }
//}
//
//
////do {
////    try validateUserPassEmail(username: username, password: password, email: email)
////} catch let error {
////    print(error)
////}
//
...
class HondaDealership{
  ...
  var availableCarSupply = ["Civic" : (price: 5000, count: 5),
    ...
    func sellCar(model: String, amountPaidDollars: Int) throws
    {
        guard var car = availableCarSupply[model] else{
            throw CarError.NoSuchModel
        }
        
        guard amountPaidDollars >= car.price else{
            throw CarError.NotEnoughMoney
        }
        
        guard car.count >= 0 else{
   
            throw CarError.OutOfStock
        }
       // var price: Int = car.price
        //print(availableCarSupply[model]!.0)
        print("you have enough money: \(amountPaidDollars) for  \(model)");
        
        //car.count = car.count - 1
        
        let numberOfCarsLeft = car.count - 1
        
        availableCarSupply[model]?.count = numberOfCarsLeft
...
var dealer: HondaDealership = HondaDealership()


do {
    try dealer.sellCar(model: "Prelude", amountPaidDollars: 10000)
